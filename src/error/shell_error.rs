...
pub enum ShellError {
    ...
    UnterminatedQuote { pos: usize, quote_char: char },
    ...
    InvalidRedirect { reason: &'static str },

    #[error("invalid file descriptor: '{fd}'")]
    InvalidFileDescriptor { fd: String },
    ...
    TooManyArgs { builtin: &'static str },

    #[error("{builtin}: missing argument")]
    MissingArgument { builtin: &'static str },

    #[error("no such job: {job_id}")]
    NoSuchJob { job_id: usize },
